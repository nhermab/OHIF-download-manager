...
import { getDownloadAvailabilityMessage } from './ohifState.js';
import {
  flattenSeries,
  buildManifest,
  seriesRow,
...
import { escapeHtml, shortUid, errorMessage, formatBytes, formatDuration } from '../utils/index.js';
import {
  canUseFolderWriter,
  defaultOutputMethod,
  folderTipMarkup,
...
} from '../anonymizer/anonymizerConfig.js';
import { DEFAULT_ANONYMIZER_CONFIG } from '../constants/app.js';
