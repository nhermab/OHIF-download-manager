...
import { TRANSFER_SYNTAX_UIDS } from "../constants/dicom.js";
import { fixOddLengthFragment } from "./dicomFixes.js";

export { TRANSFER_SYNTAX_UIDS };
...
export function encodeRLEFrame(pixelArray, imageInfo) {
  ...
  for (let s = 0; s < numSegments; s++) {
    ...
    const finalBuf = fixOddLengthFragment(compressedPlane);
