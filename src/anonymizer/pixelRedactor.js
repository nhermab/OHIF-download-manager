...
import { runOcrOnFrame } from "./ocrEngine.js";
import { extractMetadataValues, classifyPhiInOcrResults } from "./phiClassifier.js";
import {
...
export async function redactDicomPixelData(dicomDict, options = {}) {
      ...
      for (let py = minY; py <= maxY; py++) {
        for (let px = minX; px <= maxX; px++) {
          ...
          if (samplesPerPixel === 1) {
            ...
            fullTypedArray[idx] = rVal;
            fullTypedArray[idx + 1] = gVal;
            fullTypedArray[idx + 2] = bVal;
          }
        }
      }
      redactedBoxCount++;
  ...
  let outputTransferSyntax = "1.2.840.10008.1.2.1";
